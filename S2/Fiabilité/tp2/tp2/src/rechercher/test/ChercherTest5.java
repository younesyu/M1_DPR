...
public class ChercherTest5 {
	...
	public void testValeurExistante() {
		assertEquals(true,chercher.chercher5(5, test1));
	}
	
	@Test(timeout=1000)
	public void testValeurIndice0() {
		assertEquals(true, chercher.chercher5(1, test1));
	}
	
	@Test(timeout=1000)
	public void testValeurDernierIndice() {
		assertEquals(true, chercher.chercher5(8, test1));
	}
	
	@Test(timeout=5000)
	public void testValeurMulti() {
		assertEquals(true, chercher.chercher5(2, test1));
	}
	
	@Test(timeout=1000)
	public void testValeurInconnue() {
		assertEquals(false, chercher.chercher5(15, test1));
	}
	
	@Test(timeout=1000)
	public void testTableauVide() {
		assertEquals(false, chercher.chercher5(5, test2));
	}
	
	@Test(timeout=1000)
	public void testTableauNul() {
		assertEquals(false, chercher.chercher5(5, null));
	}
