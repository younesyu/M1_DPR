...
public class ChercherTest3 {
	...
	public void testValeurExistante() {
		assertEquals(true,chercher.chercher3(5, test1));
	}
	
	@Test(timeout=1000)
	public void testValeurIndice0() {
		assertEquals(true, chercher.chercher3(1, test1));
	}
	
	@Test(timeout=1000)
	public void testValeurDernierIndice() {
		assertEquals(true, chercher.chercher3(8, test1));
	}
	
	@Test(timeout=5000)
	public void testValeurMulti() {
		assertEquals(true, chercher.chercher3(2, test1));
	}
	
	@Test(timeout=1000)
	public void testValeurInconnue() {
		assertEquals(false, chercher.chercher3(15, test1));
	}
	
	@Test(timeout=1000)
	public void testTableauVide() {
		assertEquals(false, chercher.chercher3(5, test2));
	}
	
	@Test(timeout=1000)
	public void testTableauNul() {
		assertEquals(false, chercher.chercher3(5, null));
	}
